...
class BaseQueryBuilder
{
    ...
    /**
     * Constructor.
     * @param Mysql $connection the database connection.
    ...
    {
        throw new LogicException($this->db->getDialectType() . ' does not support enabling/disabling integrity check.');
    }
...
//        }
    ...
    public function buildHashCondition($condition, &$params)
    {
        ...
        foreach ($condition as $column => $value) {
            if ($this->isTraversable($value) || $value instanceof Query) {
                // IN condition
    ...
    {
        if (!isset($operands[0], $operands[1])) {
            throw new In("Operator '$operator' requires two operands.");
        }
