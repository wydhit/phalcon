...
class Bootstrapssss
{
            ...
            if (!empty($dirController) && is_array($dirController)) {
                ...
                foreach ($dirController as $value) {
                    ...
                    $group = new RouterGroup([
                        'namespace' => PROJECT_NAMESPACE . '\Controllers\\' . ucfirst($value),
                        'controller' => 'index',
                        'action' => 'index'
                    ]);
    ...
    public function registerService()
    {
        ...
        if (file_exists(PROJECT_PATH . '/config/serviceProvider.php')) {
            $serviceProviders = array_merge($serviceProviders, require(PROJECT_PATH . '/config/serviceProvider.php'));
        }
